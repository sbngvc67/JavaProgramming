...
public class ArraysUtility {
    ...
    //prints each decimal of a double array in seperate lines
    ...
    //returns the maximum number for a decimal array
    public static double max(double[] numbers){
        Arrays.sort(numbers);
        return numbers[numbers.length-1];
    }

    //returns the minimum number for an integer array
    public static int min(int[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

    //returns the minimum number for a decimal array
    public static double min(double[] numbers){
        Arrays.sort(numbers);
        return numbers[0];
    }

    //checks if the give integer is contained in the given array,returns boolean  contains(int [], int)
    ...
    //checks if the given decimal is contained in the given array,returns boolean  contains(int [], int)
   ...
   */
    ...
    //replaces the given index in the given array, returns a new array
