...
class RealEstateCalculator {
    public static void main(String[] args) {
        ...
        if(schoolScore>=8&&schoolScore<=10){propertyPrice+=45000;}
        else if(schoolScore>=4&&schoolScore<8){propertyPrice+=20000;}
        else{propertyPrice+=5000;}
        System.out.println("Does any of your family members smoke?");
        smoking=scan.nextBoolean();
        if(smoking){propertyPrice-=5000;}
        System.out.printf("Market report has been generated.\nYour estimate market price is: %d$",propertyPrice);}}
/*
